...
static const char *TAG = "serialport.cpp";
...
Java_deckyfx_reactnative_printer_serialport_SerialPort_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_deckyfx_reactnative_printer_serialport_SerialPort_open(
        JNIEnv *env,
        jobject thiz,
        jstring path,
        jint baudrate,
...
Java_deckyfx_reactnative_printer_serialport_SerialPort_close(JNIEnv *env, jobject thiz) {
